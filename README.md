...
- As for the rest work a lot with things like ... Linux, DNS, Server security, SSL, SSH, fiber optics and all the others headakes that all of us stuble upon with, when there is a problem or something needs to be done on a Computer unit.
